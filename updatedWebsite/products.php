  ...
  <div class="row">
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Extra- large variety gaining popularity.<br />
        <b>$1.00<br></b>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Packed with nutrients and is a 'good fat'.<br />
        <b>$2.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
  ...
  <div class="row">
    <div class="col-sm-4 text-center">
      ...
      <p>
        ...
        Chiquita Yellow<br />
		One of the healthiest fruits.<br />
		<b>$1.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		The bark and leaves are used for herbal medicine.<br />
        <b>$5.75</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
        ...
        Sweet and Delicious<br />
		Rosy fleshed and won't overripen on the tree.<br />
		<b>$0.80</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Interesting and desirable tropical fruit.<br />
		<b>$6.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
...
<div class="row">
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Truly remarkable food and medicine.<br />
        <b>$3.25<br></b>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Unique Aroma<br />
		King of all tropical fruits.<br />
        <b>$8.25</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Larry Itilong's rebel fruit!<br />
        <b>$2.00</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
  ...
  <div class="row">
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Sweet and Delicious<br />
		Tastes like a combination fo strawberry, pineapple, coconut and banana.<br />
        <b>$4.25<br></b>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Aromatic Flavor<br />
		Wolrd's largest tree-born fruit.<br />
        <b>$1.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Possible health benefits include lowering blood sugars.<br />
        <b>$2.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
  ...
  <div class="row">
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		A genus of flowering plants in the cashew family.<br />
        <b>$2.00<br></b>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Species of tree in the mulverry or fig family.<br />
        <b>$5.75</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Fruit for the Gods, with its very own Lanzones Festival!<br />
        <b>$5.25</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Sweetest Fruit<br />
		National fruit of the Philippines.<br />
        <b>$7.75</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Creamy and Sweet<br />
		Unique appearance and flavor.<br />
        <b>$6.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
...
<div class="row">
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Sweet and Sticky<br />
		Birds and bats love this cherry tree.<br />
        <b>$4.75<br></b>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Sweet and Juicy<br />
		The salted seeds are an addictive snack.<br />
        <b>$7.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Sweet and Tart<br />
		Is nothing short of one pretty sweet superfood.<br />
        <b>$8.00</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Believed to be a 'natural cancer cell killer.'<br />
        <b>$4.50</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		From California<br />
		The fruit that started it all!<br />
        <b>$3.00</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
    ...
    <div class="col-sm-4 text-center">
      ...
      <p>
		...
		Mild and Sweet<br />
		Largest of all citrus fruits.<br />
        <b>$3.25</b><br>
        <button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> Add to Cart</button>
      </p>
    </div>
